    ...
    return (
      <div>
        <form
          ...
          data-wizard="agc-oat-harvest-loss"
        ...
        >
          ...
          <section data-wizard-section="0">
            <div class="agc-wizard__field">
              ...
              <p data-i18n={`hints.kernels-counted`}>
                ⮤ Enter the number of oat kernels counted on the ground within
                the specified area.
              </p>
            </div>
          ...
          <section data-wizard-section="1">
            <div class="agc-wizard__field">
              ...
              <p data-i18n={`hints.loss-area`}>
                ⮤ Enter the area in square feet that was used to count oat
